...
- When the Home Route is opened,
  - HTTP GET request to the **teamsApiUrl**
  - **_loader_** will be displayed while fetching the data
  - After fetching the data, the list of teams are displayed
...
- When the Team Matches Route is opened,
  - The HTTP GET request to the **teamMatchesApiUrl** with the team id to get the recent matches data of the team
